...
var Credits = function (_Component) {
  ...
  function Credits() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Credits.__proto__ || _Object$getPrototypeOf(Credits)).call.apply(_ref, [this].concat(args))), _this), _this.updateCredits = function (config) {
  ...
  _createClass(Credits, [{
    ...
    value: function componentDidMount() {
      ...
      this.updateCredits(_extends({}, rest, {
        text: text
      }));
    }
  }, {
